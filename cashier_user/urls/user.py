from cashier_user.views.user import UserModelViewSets, UpdateUserAPIView,AccountsMeAPIView, UpdateEmployeAPIView, DestroyEmployeManyToMany
...
urlpatterns = [
    ...
    path('acounts/destroy/employe/<objects>', DestroyEmployeManyToMany.as_view() ,name="destroy-employe")
]