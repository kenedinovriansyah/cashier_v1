    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('public_id', models.CharField(max_length=225, unique=True)),
                ('phone_numbers', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region=None, unique=True)),
                ('phone_fax', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region=None)),
            ],
        ),
        migrations.CreateModel(
            name='Type',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('public_id', models.CharField(max_length=225, unique=True)),
                ('type', models.IntegerField(choices=[(0, 'Member'), (1, 'Staff'), (2, 'Owner')], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='Accounts',
            fields=[
                ...
                ('phone', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.phone')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.type')),
